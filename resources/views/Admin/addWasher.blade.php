...
<form method="post" action="/Washer" enctype="multipart/form-data" style="margin-top: 3%">
    {{csrf_field()}}

    Washer Name: <input type="text" name="washer_name" title="" value="{{$washer->washer_name or ''}}"><br><br>
    Washer Branch:<input type="text" name="branch_id" title="" value="{{$washer->branch_id or ''}}"><br>
    <input type="hidden" name="id" value="{{$washer->id or ''}}">
