    ...
    <div class="table-container">
        <table class="table">
            ...
            <tr>
                ...
                <th scope="col"> Branch Opening</th>
                <th scope="col"> Branch Closing</th>
            </tr>
            </thead>
            @foreach($branch as $branchs)
                ...
                <tr>
                    ...
                    <td>{{$branchs->latitude}}</td>
                    <td>{{$branchs->longitude}}</td>
                    <td>{{$branchs->opening_time}}</td>
                    <td>{{$branchs->closing_time}}</td>
                    <td><a href="/Branch/View/{{$branchs->id}}">Edit</a></td>
                </tr>
                </tbody>
            @endforeach
        </table>
...
<!--<table border="1" style="margin-top: 3%">
    <tr>
        ...
        <th> Branch Opening</th>
        <th>Branch Closing  </th>
    </tr>
    @foreach($branch as $branchs)
    <tr>
        <td>{{$branchs->branch_name}}</td>
