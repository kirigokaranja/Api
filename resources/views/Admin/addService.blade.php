...
<div class="container">
    <form method="post" action="/Service" enctype="multipart/form-data" style="margin: 3%">
        {{csrf_field()}}
        ...
        Service Name: <input type="text" name="service_name" title="" value="{{$service->service_name or ''}}"><br><br>
        Service Duration: <input type="text" name="duration" title="" value="{{$service->duration or ''}}"><br><br>
        Service Price: <input type="text" name="price" title="" value="{{$service->price or ''}}"><br><br>
        Service Details: <input type="text" name="details" title="" value="{{$service->details or ''}}"><br><br>
        <input type="hidden" name="id" value="{{$service->id or ''}}">
        <button type="submit">Submit Service</button>
    </form>
</div>

<!--<form method="post" action="/Service" enctype="multipart/form-data" style="margin-top: 3%">
    {{csrf_field()}}
