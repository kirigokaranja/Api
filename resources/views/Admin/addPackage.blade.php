...
<div class="container">
    <form method="post" action="/Package" enctype="multipart/form-data" style="margin: 3%">
        {{csrf_field()}}
        ...
        Package Name: <input type="text" name="package_name" title="" value="{{$package->package_name or ''}}"><br><br>
        Package price: <input type="text" name="price" title="" value="{{$package->price or ''}}"><br><br>
        Package Time: <input type="text" name="time_period" title="" value="{{$package->time_period or ''}}"><br><br>
        Package Details: <input type="text" name="details" title="" value="{{$package->details or ''}}"><br><br>
        <input type="hidden" name="id" value="{{$package->id or ''}}">
        <button type="submit">Submit Package</button>
    </form>
</div>

<!--<form method="post" action="/Package" enctype="multipart/form-data" style="margin-top: 3%">
    {{csrf_field()}}
